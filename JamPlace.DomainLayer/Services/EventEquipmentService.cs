...
namespace JamPlace.DomainLayer.Services
{
    ...
    {
        private readonly IEquipmentRepository _equipmenttRepository;
        private readonly IJamEventRepository _jamEventRepository;
        private readonly IJamUserRepository _jamUserRepository;

        public EventEquipmentService(IEquipmentRepository eqRepository, IJamEventRepository jamEventRepository, IJamUserRepository jamUserRepository)
        {
